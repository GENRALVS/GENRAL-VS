...
if matches[1] == "ia" and not matches[3] then
    return instagramUser(msg,matches[2])
end
if matches[1] == "ia" and matches[3] then
...
return {
   patterns = {
   "^/(ia) ([Hh]ttps://www.instagram.com/p/)([^%s]+)$",
   "^/(ia) ([Hh]ttps://instagram.com/p/)([^%s]+)$",
   "^/(ia) ([Hh]ttp://www.instagram.com/p/)([^%s]+)$",
   "^/(ia) ([Hh]ttp://instagram.com/p/)([^%s]+)$",
   "^/(ia) ([^%s]+)$",
   },
   run = run
}
