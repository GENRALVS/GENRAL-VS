...
send_api_msg(msg, get_receiver_api(msg), text, true, 'md')
  ...
  if matches[1]:lower() == "mbbn" then -- Ban list !
    local chat_id = msg.to.id
  ...
  if matches[1]:lower() == 'bb' then-- /ban
...
if matches[1]:lower() == 'kk' then
	...
	if matches[1]:lower() == 'bbn' then-- /ban
    if type(msg.reply_id)~="nil" and is_momod(msg) then
      if is_admin1(msg) then
 ...
 if matches[1]:lower() == 'ubbn' then-- /ban
    if type(msg.reply_id)~="nil" and is_momod(msg) then
      if is_admin1(msg) then
...
if matches[1]:lower() == 'ubb' then-- /ban
    if type(msg.reply_id)~="nil" and is_momod(msg) then
      if is_admin1(msg) then
  ...
  if matches[1]:lower() == "mgbb" then -- Global ban list
    return banall_list()
  end
end
